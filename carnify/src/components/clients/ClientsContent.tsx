...
import {
  ...
  addSaleToAccount as dbAddSaleToAccount,
  closePeriod as dbClosePeriod,
...
export default function ClientsContent() {
  ...
  async function handleSaveClient(e: React.FormEvent) {
    e.preventDefault();
    if (modal === 'addClient') {
      await dbCreateClient(clientForm);
    } else {
      if (selectedClient) await dbUpdateClient(selectedClient.id, clientForm);
    }
